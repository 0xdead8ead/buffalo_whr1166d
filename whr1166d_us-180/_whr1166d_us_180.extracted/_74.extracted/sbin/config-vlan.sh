...
# $Id: config-vlan.sh,v 1.45 2012-04-16 08:28:48 kurtis Exp $
#
...
usage()
{
	...
	echo "  $0 3 0 - restore Ralink RT6855/MT7620 ESW to no VLAN partition"
	echo "  $0 3 LLLLW - config Ralink RT6855/MT7620 ESW with VLAN and WAN at port 4"
	echo "  $0 3 WLLLL - config Ralink RT6855/MT7620 ESW with VLAN and WAN at port 0"
	echo "  $0 3 12345 - config Ralink RT6855/MT7620 ESW with VLAN 1~5 at port 0~4"
	echo "  $0 3 GW - config Ralink RT6855/MT7620 ESW with WAN at Giga port"
