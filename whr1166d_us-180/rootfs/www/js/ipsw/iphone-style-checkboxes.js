  ...
  return(elems.each(function(elem) {
    ...
    elem.change = function(auto) {
      ...
      if(typeof(auto) === "undefined")
      {
        ...
        //alert("bp=" + iPhoneStyle.dragStartPositionBool + " ap=" + iPhoneStyle.dragEndPositionBool);
        if(iPhoneStyle.dragStartPositionBool != iPhoneStyle.dragEndPositionBool){
          options.statusChange(elem);
        }
      }
    };
    ...
    var down = function(e) {
      ...
      Event.stop(e);
      iPhoneStyle.dragStartPositionBool = elem.checked;
    };
    ...
    var up = function(e) {
      if (iPhoneStyle.clicking == handle) {
        ...
        if (!iPhoneStyle.dragging) {
          ...
          iPhoneStyle.dragEndPositionBool = !is_onstate ;
        } else {
          var x = Event.pointerX(e) || e.changedTouches[0].pageX;
          var p = (x - iPhoneStyle.dragStartPosition) / rightside;
          elem.writeAttribute('checked', (p >= 0.5));
          iPhoneStyle.dragEndPositionBool = (p >= 0.5) ;
        }
...
iPhoneStyle.defaults = {
  ...
  statusChange: function(elem){handleChange(elem);}
};
